    ...
    return (
        <div className="flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400">
            ...
            {!isEmailSent &&
                <form onSubmit={onSubmitEmail} className="bg-slate-900 p-8 rounded-lg shadow-lg text-sm w-96">
                    ...
                    <div className="mb-4 flex items-center  gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]">
                        ...
                        <input required value={email} onChange={(e) => setEmail(e.target.value)} type="email" placeholder="Email id" className="bg-transparent outline-none w-full text-white" />
            ...
            {/* Form for adding OTP */}
            {
                ...
                <form onSubmit={onSubmitOTP} className="bg-slate-900 p-8 rounded-lg shadow-lg text-sm w-96">
                    <h1 className="text-white text-2xl font-semibold text-center mb-4">Reset Password OTP</h1>
                    <p className="text-center mb-6 text-indigo-300">Enter the 6-digit OTP sent to your email address.</p>
            ...
            {isEmailSent && isOtpSubmitted &&
                ...
                <form onSubmit={onSubmitNewPassword} className="bg-slate-900 p-8 rounded-lg shadow-lg text-sm w-96">
                    ...
                    <div className="mb-4 flex items-center  gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]">
                        ...
                        <input required value={newPassword} onChange={(e) => setNewPassword(e.target.value)} type="password" placeholder="New Password" className="bg-transparent outline-none w-full text-white" />
